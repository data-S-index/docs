...
> **Auto-generated profiles are not a substitute for a user-created profile.** For an
> accurate S-index, researchers should [create a profile](https://scholardata.io/signup),
> claim their datasets, and let Scholar Data compute their score.

...
Your FAIR score is calculated by F-UJI based on the metadata your repository exposes. So both the repository you choose and how much metadata you provide through it matter. Share your datasets on repositories that expose metadata properly, and fill in as much metadata as the repository allows when depositing your data.

To check how FAIR-enabling a repository is before choosing one, select a few of its existing datasets and run them through the [F-UJI web tool](https://www.f-uji.net/?action=test) yourself.
...
Datasets that are well organized, shared with standard file formats, and properly documented are easier for other researchers to reuse. Since citations and mentions only accumulate when someone actually reuses your data, making that reuse as frictionless as possible directly increases your odds of earning them.

...
The FAIR score is calculated using [F-UJI](../data-collection/fair-scores.md), which relies on the dataset metadata exposed by a repository. So both the repository you choose and how much metadata you provide through it matter.
